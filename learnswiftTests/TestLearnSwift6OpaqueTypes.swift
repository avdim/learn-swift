...
//    }
    ...
    func protoFlip3<T: Shape>(_ shape: T) -> Shape {
        if shape is Square {
            return shape
        }
    ...
    let protoFlippedTriangle = protoFlip3(smallTriangle)
    let sameThing = protoFlip3(smallTriangle)
//    protoFlippedTriangle == sameThing  // Error """Binary operator '==' cannot be applied to two 'Shape' operands"""
...
//private func makeProtocolContainer<T>(item: T) -> Container3 {
//    return [item]
//}

//// Error: Not enough information to infer C.
//private func makeProtocolContainer<T, C: Container3>(item: T) -> C {
//    return [item]
//}
